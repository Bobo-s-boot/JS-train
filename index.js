...
class Band {
  ...
  // До приватного поля #members яке є масивом додаємо Hового музиканта
...
class Concert extends Performance {
  ...
  // Використовуємо super для виклику конструктора базового класу
  ...
  // Визначаємо метод info(), що виводить рядок в консоль `Гурт ${this.brand.name} виступить в ${this.location} ${this.date.toLocaleDateString()}, ціна квитка ${this.#ticketPrice}`
  ...
  info() {
    console.log(
      `Гурт ${this.brand.name} виступить в ${
        this.location
 ...
 */
const musician = new Musician("John", "guitar");
