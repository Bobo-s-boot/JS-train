...
const driveTruck = myTruck.drive.bind(myTruck);
...
const myElrctricCar = new ElectricCar("Tesla", "Model S", 2020, 10000, 100);
/*
...
console.log(myElrctricCar.toString());
