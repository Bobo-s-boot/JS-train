...
function extendAndFreezeObject(obj1, obj2) {
  ...
  const frozenObj = Object.freeze(extendedObj);
...
function filterObjectsByKey(arr, key) {
  ...
  const result = arr.filter((obj) => obj.hasOwnProperty(key));
...
function sealAndCheck(obj) {
  ...
  const result = Object.isSealed(a);
...
function checkOwnership(obj1, obj2, key) {
  ...
  const chechk1 = obj1.hasOwnProperty(key);
  const chechk2 = obj2.hasOwnProperty(key);
