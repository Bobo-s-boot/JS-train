...
function findIndexByProperty(arr, name) {
  ...
  const a = arr.findIndex((index) => index.name === name);
...
function findLastEvenNumber(arr) {
  ...
  const b = arr.findLast((num) => num % 2 === 0);
...
function getPositiveArrayValues(arr) {
  ...
  const f = Array.from(arr.values()).filter((num) => num > 0);
...
function removeAndDouble(arr, startIdx) {
  ...
  const q = arr.splice(startIdx);
  const w = arr.map((num) => num * 2);
...
function sumAndPrint(arr) {
  ...
  const s = arr.forEach((element) => console.log(element));
...
function flattenSquareAndFilter(arr, threshold) {
  ...
  const e = arr.flat();
  const p = e.map((element) => element ** 2);
  const g = p.filter((element) => element > threshold);
...
function getLastElementsSumAndPrint(arr, n) {
  ...
  const v = arr.slice(-n);
  const x = v.reduceRight(
    (accumulator, currentValue) => accumulator + currentValue,
    0
  );
  const l = v.forEach((element) => console.log(element));
...
function wordLengths(arr) {
  ...
  const t = arr.map((element) => element.length);
...
function findLongestWord(arr) {
  ...
  const longestWord = arr.reduce((acc, curr) => {
...
function findLastNegativeNumberIndex(arr) {
  ...
  const p = arr.findLastIndex((element) => element < 0);
