...
function setValue(dictionary, key, value) {
  ...
  if (dictionary.has(upperCaseKey)) {
    dictionary.set(upperCaseKey, value.toUpperCase());
  } else {
    dictionary.set(upperCaseKey, upperCaseKey);
  }
...
function convertSetToDictionary(set) {
  ...
  for (const element of set) {
    ...
    resultDictionary.set(element, firstCharCode);
  }
